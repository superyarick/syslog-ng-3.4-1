...
AFInetDestDriver *afinet_dd_new(gint af, gint sock_type, gchar *host);
AFInetDestDriver *afsyslog_dd_new(gchar *host);
AFInetDestDriver *afnetwork_dd_new(gchar *host);
